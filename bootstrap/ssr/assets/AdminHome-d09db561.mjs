...
function AdminTable(props) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "table-responsive", children: /* @__PURE__ */ jsx("div", { className: "w-full overflow-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
    /* @__PURE__ */ jsx("thead", { className: "bg-gray-50", children: /* @__PURE__ */ jsxs("tr", { children: [
      /* @__PURE__ */ jsx("th", { scope: "col", className: "hidden md:table-cell px-6 py-3 text-xs font-bold text-left text-gray-500 uppercase", children: "ID" }),
      /* @__PURE__ */ jsx("th", { scope: "col", className: "px-6 py-3 text-xs font-bold text-left text-gray-500 uppercase", children: "Name" }),
      /* @__PURE__ */ jsx("th", { scope: "col", className: "hidden md:table-cell px-6 py-3 text-xs font-bold text-left text-gray-500 uppercase", children: "Email" }),
      /* @__PURE__ */ jsx("th", { scope: "col", className: "hidden md:table-cell px-6 py-3 text-xs font-bold text-left text-gray-500 uppercase", children: "Role" }),
      /* @__PURE__ */ jsx("th", { scope: "col", className: "px-6 py-3 text-xs font-bold text-left text-gray-500 uppercase", children: "Edit" }),
      /* @__PURE__ */ jsx("th", { scope: "col", className: "px-6 py-3 text-xs font-bold text-left text-gray-500 uppercase", children: "Delete" })
    ] }) }),
    /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-200", children: JSON.parse(props.props[0]).map(({ id, name, email, role }) => /* @__PURE__ */ jsxs("tr", { children: [
      /* @__PURE__ */ jsx("td", { name: "id", className: "hidden md:table-cell px-6 py-4 text-sm text-gray-800 whitespace-nowrap", children: id }),
      /* @__PURE__ */ jsx("td", { name: "name", className: "px-6 py-4 text-sm text-gray-800 whitespace-nowrap", children: name }),
      /* @__PURE__ */ jsx("td", { name: "email", className: "hidden md:table-cell px-6 py-4 text-sm text-gray-800 whitespace-nowrap", children: email }),
      /* @__PURE__ */ jsx("td", { name: "role", className: "hidden md:table-cell px-6 py-4 text-sm text-gray-800 whitespace-nowrap", children: role }),
      /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-sm font-medium text-left whitespace-nowrap", children: /* @__PURE__ */ jsx("a", { className: "text-green-500 hover:text-green-700", href: `AdminUpdatePage?id=${id}`, children: /* @__PURE__ */ jsx(EditIcon, {}) }) }),
