...
const addToPersons$1 = (data, persons, allPersons) => {
  data.forEach((item) => {
...
function SchedulerComponent$1(data) {
  ...
  const persons = [];
  const renderPersons = () => {
    addToPersons$1(data.data, persons, data.allPersons);
...
function ProjectUpdateComponent(props) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { className: "flex justify-center align-center p-12", children: /* @__PURE__ */ jsx("div", { style: formContainerStyle, children: /* @__PURE__ */ jsxs("form", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: inputStyle, children: [
        /* @__PURE__ */ jsx(InputLabel, { className: "mt-4", forInput: "note", value: "Notiz" }),
        /* @__PURE__ */ jsx(
          "textarea",
          {
            id: "note",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-center align-center", children: [
      /* @__PURE__ */ jsx("form", { onSubmit: handleInsert, children: /* @__PURE__ */ jsx(UniversalButton, { type: "submit", text: "Senden" }) }),
      /* @__PURE__ */ jsx("form", { onSubmit: handleCancel, children: /* @__PURE__ */ jsx(UniversalButton, { type: "submit", text: "Zurück" }) })
    ] })
  ] }) });
}
