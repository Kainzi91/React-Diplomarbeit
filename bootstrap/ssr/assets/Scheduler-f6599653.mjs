...
function DropdownForm(projects, onHandleChange, value) {
  console.log(projects);
  return /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
    /* @__PURE__ */ jsx("label", { htmlFor: "projectName", className: "block font-medium text-gray-700", children: "Projektname" }),
      ...
      /* @__PURE__ */ jsxs(
        "select",
        {
          ...
          children: [
            ...
            projects.projects.map(({ name }) => /* @__PURE__ */ jsx("option", { value: name, children: name }, name))
          ]
        }
      ),
  ...
  const renderPersons = () => {
    ...
    return persons.map((person, index) => {
              ...
              children: /* @__PURE__ */ jsxs(Popover, { className: "relative", children: [
                ...
                /* @__PURE__ */ jsx(Popover.Panel, { className: "fixed z-50 top-0 left-0 w-screen h-screen flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "bg-gray-400 rounded-lg", children: [
                  /* @__PURE__ */ jsx("div", { className: "bg-gray-400 rounded-lg mt-2 mr-2", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx(Exit, {}) })
                  ] }) }),
                  /* @__PURE__ */ jsx(
      ...
      return /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx("td", { className: "border px-3 py-2", style: stickyColumnStyles, children: /* @__PURE__ */ jsxs(Popover, { className: "relative", children: [
