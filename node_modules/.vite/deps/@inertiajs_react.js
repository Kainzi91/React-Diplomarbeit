...
function F(t, e, r, i = "brackets") {
  let s = /^https?:\/\//.test(e.toString()), n = s || e.toString().startsWith("/"), u = !n && !e.toString().startsWith("#") && !e.toString().startsWith("?"), f = e.toString().includes("?") || t === "get" && Object.keys(r).length, b = e.toString().includes("#"), l = new URL(e.toString(), "http://localhost");
  return t === "get" && Object.keys(r).length && (l.search = C.stringify((0, import_deepmerge.default)(C.parse(l.search, { ignoreQueryPrefix: true }), r), { encodeValuesOnly: true, arrayFormat: i }), r = {}), [[s ? `${l.protocol}//${l.host}` : "", n ? l.pathname : "", u ? l.pathname.substring(1) : "", f ? l.search : "", b ? l.hash : ""].join(""), r];
}
function x(t) {
...
var N = class {
  ...
  visit(e, { method: r = "get", data: i = {}, replace: s = false, preserveScroll: n = false, preserveState: u = false, only: f = [], headers: b = {}, errorBag: l = "", forceFormData: c = false, onCancelToken: v2 = () => {
  }, onBefore: R2 = () => {
  }, onStart: d = () => {
  }, onProgress: p = () => {
  }, onFinish: V = () => {
    ...
    let P = typeof e == "string" ? g(e) : e;
    if ((L(i) || c) && !(i instanceof FormData) && (i = k(i)), !(i instanceof FormData)) {
      let [o, a] = F(r, P, i, I);
      P = g(o), i = a;
    }
    let S = { url: P, method: r, data: i, replace: s, preserveScroll: n, preserveState: u, only: f, headers: b, errorBag: l, forceFormData: c, queryStringArrayFormat: I, cancelled: false, completed: false, interrupted: false };
    if (R2(S) === false || !H(S))
      return;
    this.activeVisit && this.cancelVisit(this.activeVisit, { interrupted: true }), this.saveScrollPositions();
    let M = this.createVisitId();
    this.activeVisit = { ...S, onCancelToken: v2, onBefore: R2, onStart: d, onProgress: p, onFinish: V, onCancel: y, onSuccess: D2, onError: U2, queryStringArrayFormat: I, cancelToken: new AbortController() }, v2({ cancel: () => {
      this.activeVisit && this.cancelVisit(this.activeVisit, { cancelled: true });
    } }), B(S), d(S), axios_default({ method: r, url: x(P).href, data: r === "get" ? {} : i, params: r === "get" ? i : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...b, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...f.length ? { "X-Inertia-Partial-Component": this.page.component, "X-Inertia-Partial-Data": f.join(",") } : {}, ...l && l.length ? { "X-Inertia-Error-Bag": l } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (o) => {
      ...
      if (this.isLocationVisitResponse(o.response)) {
        let a = g(o.response.headers["x-inertia-location"]), E2 = P;
...
function Y(t, e, r) {
  ...
  function b() {
    let c = e(""), v2 = { ...c ? { title: `<title inertia="">${c}</title>` } : {} }, R2 = Object.values(i).reduce((d, p) => d.concat(p), []).reduce((d, p) => {
      if (p.indexOf("<") === -1)
        return d;
      ...
      return V ? d[V[0]] = p : d[Object.keys(d).length] = p, d;
    }, v2);
...
var B2 = (0, import_react3.createContext)(void 0);
B2.displayName = "InertiaHeadContext";
var A2 = B2;
var N2 = (0, import_react4.createContext)(void 0);
N2.displayName = "InertiaPageContext";
var E = N2;
function L2({ children: l, initialPage: c, initialComponent: s, resolveComponent: p, titleCallback: a, onHeadUpdate: P }) {
  let [d, S] = (0, import_react2.useState)({ component: s || null, page: c, key: null }), u = (0, import_react2.useMemo)(() => Y(typeof window > "u", a || ((f) => f), P || (() => {
  })), []);
  if ((0, import_react2.useEffect)(() => {
    Je.init({ initialPage: c, resolveComponent: p, swapComponent: async ({ component: f, page: e, preserveState: i }) => {
      S((r) => ({ component: f, page: e, key: i ? r.key : Date.now() }));
    } }), Je.on("navigate", () => u.forceUpdate());
  }, []), !d.component)
    return (0, import_react2.createElement)(A2.Provider, { value: u }, (0, import_react2.createElement)(E.Provider, { value: d.page }, null));
  let g2 = l || (({ Component: f, props: e, key: i }) => {
    let r = (0, import_react2.createElement)(f, { key: i, ...e });
    return typeof f.layout == "function" ? f.layout(r) : Array.isArray(f.layout) ? f.layout.concat(r).reverse().reduce((y, T2) => (0, import_react2.createElement)(T2, { children: y, ...e })) : r;
  });
  return (0, import_react2.createElement)(A2.Provider, { value: u }, (0, import_react2.createElement)(E.Provider, { value: d.page }, g2({ Component: d.component, key: d.key, props: d.page.props })));
}
L2.displayName = "Inertia";
async function U({ id: l = "app", resolve: c, setup: s, title: p, progress: a = {}, page: P, render: d }) {
  let S = typeof window > "u", u = S ? null : document.getElementById(l), g2 = P || JSON.parse(u.dataset.page), f = (r) => Promise.resolve(c(r)).then((y) => y.default || y), e = [], i = await f(g2.component).then((r) => s({ el: u, App: L2, props: { initialPage: g2, initialComponent: r, resolveComponent: f, titleCallback: p, onHeadUpdate: S ? (y) => e = y : null } }));
  if (!S && a && ee(a), S) {
    let r = await d((0, import_react.createElement)("div", { id: l, "data-page": JSON.stringify(g2) }, i));
...
var oe2 = function({ children: l, title: c }) {
  ...
  function P(e) {
    let i = Object.keys(e.props).reduce((r, y) => {
      if (["head-key", "children", "dangerouslySetInnerHTML"].includes(y))
        return r;
      let T2 = e.props[y];
      return T2 === "" ? r + ` ${y}` : r + ` ${y}="${T2}"`;
    }, "");
    return `<${e.type}${i}>`;
  }
  function d(e) {
    return typeof e.props.children == "string" ? e.props.children : e.props.children.reduce((i, r) => i + S(r), "");
  }
  function S(e) {
    let i = P(e);
  ...
  function f(e) {
    let i = (Array.isArray(e) ? e : [e]).filter((r) => r).map((r) => g2(r));
...
var de = (0, import_react6.forwardRef)(({ children: l, as: c = "a", data: s = {}, href: p, method: a = A.GET, preserveScroll: P = false, preserveState: d = null, replace: S = false, only: u = [], headers: g2 = {}, queryStringArrayFormat: f = "brackets", onClick: e = k2, onCancelToken: i = k2, onBefore: r = k2, onStart: y = k2, onProgress: T2 = k2, onFinish: H2 = k2, onCancel: F2 = k2, onSuccess: M = k2, onError: b = k2, ...O2 }, I) => {
  let x2 = (0, import_react6.useCallback)((o) => {
    e(o), te(o) && (o.preventDefault(), Je.visit(p, { data: s, method: a, preserveScroll: P, preserveState: d ?? a !== "get", replace: S, only: u, headers: g2, onCancelToken: i, onBefore: r, onStart: y, onProgress: T2, onFinish: H2, onCancel: F2, onSuccess: M, onError: b }));
  }, [s, p, a, P, d, S, u, g2, e, i, r, y, T2, H2, F2, M, b]);
  c = c.toLowerCase(), a = a.toLowerCase();
  let [h2, t] = F(a, p || "", s, f);
  return p = h2, s = t, c === "a" && a !== "get" && console.warn(`Creating POST/PUT/PATCH/DELETE <a> links is discouraged as it causes "Open Link in New Tab/Window" accessibility issues.

Please specify a more appropriate element using the "as" attribute. For example:

<Link href="${p}" method="${a}" as="button">...</Link>`), (0, import_react6.createElement)(c, { ...O2, ...c === "a" ? { href: p } : {}, ref: I, onClick: x2 }, l);
});
var fe = de;
function w2(l, c) {
...
function K2(l, c) {
  let s = (0, import_react7.useRef)(null), p = typeof l == "string" ? l : null, [a, P] = (0, import_react7.useState)((typeof l == "string" ? c : l) || {}), d = (0, import_react7.useRef)(null), S = (0, import_react7.useRef)(null), [u, g2] = p ? w2(a, `${p}:data`) : (0, import_react7.useState)(a), [f, e] = p ? w2({}, `${p}:errors`) : (0, import_react7.useState)({}), [i, r] = (0, import_react7.useState)(false), [y, T2] = (0, import_react7.useState)(false), [H2, F2] = (0, import_react7.useState)(null), [M, b] = (0, import_react7.useState)(false), [O2, I] = (0, import_react7.useState)(false), x2 = (t) => t;
  (0, import_react7.useEffect)(() => (s.current = true, () => {
    s.current = false;
  }), []);
  let h2 = (0, import_react7.useCallback)((t, o, n = {}) => {
    let C2 = { ...n, onCancelToken: (m2) => {
      if (d.current = m2, n.onCancelToken)
        return n.onCancelToken(m2);
    }, onBefore: (m2) => {
      if (b(false), I(false), clearTimeout(S.current), n.onBefore)
        return n.onBefore(m2);
    }, onStart: (m2) => {
      if (T2(true), n.onStart)
        return n.onStart(m2);
    }, onProgress: (m2) => {
      if (F2(m2), n.onProgress)
        return n.onProgress(m2);
    }, onSuccess: (m2) => {
      if (s.current && (T2(false), F2(null), e({}), r(false), b(true), I(true), S.current = setTimeout(() => {
        s.current && I(false);
      }, 2e3)), n.onSuccess)
        return n.onSuccess(m2);
    }, onError: (m2) => {
      if (s.current && (T2(false), F2(null), e(m2), r(true)), n.onError)
        return n.onError(m2);
    }, onCancel: () => {
      if (s.current && (T2(false), F2(null)), n.onCancel)
        return n.onCancel();
    }, onFinish: () => {
      if (s.current && (T2(false), F2(null)), d.current = null, n.onFinish)
        return n.onFinish();
    } };
    t === "delete" ? Je.delete(o, { ...C2, data: x2(u) }) : Je[t](o, x2(u), C2);
  }, [u, e]);
  return { data: u, setData(t, o) {
    g2(typeof t == "string" ? { ...u, [t]: o } : typeof t == "function" ? (n) => t(n) : t);
  }, isDirty: !(0, import_lodash.default)(u, a), errors: f, hasErrors: i, processing: y, progress: H2, wasSuccessful: M, recentlySuccessful: O2, transform(t) {
    x2 = t;
  }, setDefaults(t, o) {
    P(typeof t > "u" ? () => u : (n) => ({ ...n, ...typeof t == "string" ? { [t]: o } : t }));
  }, reset(...t) {
    t.length === 0 ? g2(a) : g2(Object.keys(a).filter((o) => t.includes(o)).reduce((o, n) => (o[n] = a[n], o), { ...u }));
  }, setError(t, o) {
    e((n) => {
    ...
    e((o) => {
      let n = Object.keys(o).reduce((C2, m2) => ({ ...C2, ...t.length > 0 && !t.includes(m2) ? { [m2]: o[m2] } : {} }), {});
